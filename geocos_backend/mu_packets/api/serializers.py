...
from geocos_backend.mu_packets.services import parse_timestamp

MEASUREMENT_NAME_PATTERN = re.compile(r"^[A-Za-z0-9_.:-]+$")
DEVICE_PATTERN = re.compile(r"^[A-Za-z0-9_.:-]+(?:\.[A-Za-z0-9_.:-]+)*$")
...
class PacketRecordSerializer(serializers.Serializer):
    ...
    def validate_measurements(self, value: dict[str, Any]) -> dict[str, Any]:
        ...
        for name, raw in value.items():
            ...
            if not MEASUREMENT_NAME_PATTERN.match(name):
